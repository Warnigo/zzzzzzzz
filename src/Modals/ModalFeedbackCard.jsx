...
const ModalFeedbackCard = ({ feedback, setFeedback }) => {
    const [value, setValue] = useState()
    const [showModal, setShowModal] = useState(false);
    const [carFeedback, setCarFeedback] = useState(feedback);
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <div className='my-2 md:my-4'>
                                                    <input checked id="default-radio" type="radio" value="1" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 " />
                                                    <label for="default-radio" class="ms-2 text-sm md:text-base  text-gray-900 ">Zhenhao helped me archive my goal completely.</label>
                                                </div>
                                                <div className='my-2 md:my-4'>
                                                    <input checked id="default-radio-2" type="radio" value="2" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 " />
                                                ...
                                                <div className='my-2 md:my-4'>
                                                    <input checked id="default-radio-3" type="radio" value="3" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 " />
                                                ...
                                                <div className='my-2 md:my-4'>
                                                    <input  id="default-radio-4" type="radio" value="4" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 " />
