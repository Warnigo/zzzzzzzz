...
const ModalAddSocialMedia = () => {
    const [isActive, setIsActive] = useState(false);
    const [selectedOption, setSelectedOption] = useState('Select your option');
  
    const options = [
        { icon: <img src={svg_facebook} />, text: 'Facebook' },
        { icon: <img src={svg_youtube} />, text: 'Youtube' },
        { icon: <img src={svg_linkedin} />, text: 'Linkedin' },
      { icon: <img src={svg_instagram} />, text: 'Instagram' },
      { icon: <img src={svg_x} />,  text: 'X' },
      { icon: <img src={svg_tiktok} />,  text: 'Tik Tok' },
      { icon: <img src={svg_whatsapp} />,  text: 'WhatsApp' },
    ];
